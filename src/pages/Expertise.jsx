...
const INSTRUMENTS = [
  {
    ...
    use: "Air volume through registers, diffusers and grilles",
    origin: "USA",
  },
  {
  ...
  },
  {
    ...
    use: "Air velocity and temperature, flow rate, averaging",
    origin: "Germany",
  },
  {
    name: "Shortridge Multimeters",
    use: "HVAC pressure measurement, duct velocity with Pitot probes",
    origin: "USA",
  },
  {
  ...
  },
  {
    ...
    use: "Hydronic differential pressure",
    origin: "",
  },
  { name: "Pitot Tube", use: "Duct velocity traverse measurement", origin: "" },
  { name: "Balmac Vibration Meter", use: "Vibration measurement", origin: "" },
  {
    name: "Integrating Sound Level Meter",
    use: "Sound level measurement (dBA & NC)",
    origin: "",
  },
  { name: "Digital Photometer", use: "Lighting level measurement", origin: "" },
  {
...
const WHY = [
  {
    no: "01",
    title: "INDEPENDENCE",
    text: "EBC provides independent commissioning managers, engineers and technicians who integrate into project teams to deliver safe building services and systems.",
  },
  {
    no: "02",
    title: "CERTIFIED EXPERTISE",
    text: "A NEBB certified TAB and commissioning provider. Works are delivered by qualified engineers operating to NEBB, ASHRAE, AABC and IEE codes of practice.",
  },
  {
    no: "03",
    title: "MEASUREMENT",
    text: "State-of-the-art instrumentation — capture hoods, manometers, anemometers, particle counters — with accurate recording of all results.",
  },
  {
    no: "04",
    title: "DOCUMENTATION",
    text: "Commissioning documentation, test data, inspection reports and certificates that serve as the historical record of key delivery team decisions.",
  },
  {
    no: "05",
    title: "PERFORMANCE",
    text: "Confirmation of operability of the facility in terms of performance, reliability, safety and security — maintained for the building's entire life cycle.",
  },
];
